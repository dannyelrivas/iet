...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>vendor/fancybox/jquery.fancybox.pack.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js"></script>

        <script src="<?php echo base_url(); ?>custom/js/config.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>custom/js/colaborador.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="page-title">
                <h3 class="text-center">Estudios asignados</h3>
            </div><!--row-->

            <div class="row">
                <ul class="nav nav-tabs">
                  <li role="presentation" class="active"><?php echo anchor('cliente', 'Estudios asignados', array('class'=>'menu-socioeconomico')); ?></li>
