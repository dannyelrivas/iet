    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="page-title">
                <h3 class="text-center">Interfaz de clientes</h3>
            </div><!--row-->

            <div class="row">
                <ul class="nav nav-tabs">
                  <li role="presentation" class="active"><?php echo anchor('cliente', 'Nuevo Perfil', array('class'=>'block left menu-evaluaciones')); ?></li>
                  <li role="presentation" class="pull-right"><?php echo anchor('login/logout', 'Cerrar Sesi&oacute;n ['.$cliente->login.']', array('class'=>'action_logout label label-danger')); ?></li>
                </ul>
            </div><!--row-->
